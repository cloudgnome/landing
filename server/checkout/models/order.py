...
from checkout.models import Departament,Payment,Status
...
class Order(models.Model):
    ...
    departament = models.ForeignKey(Departament,verbose_name=_('Відділення'),null=True, on_delete=models.SET_NULL)
    payment = models.ForeignKey(Payment, on_delete = models.SET_NULL)
    status = models.ForeignKey(Payment, on_delete = models.SET_NULL)
    ...
    @property
    def full_name(self):
        return "%s %s %s" % ( or '',self.lname or '',self.sname or '')
