...
try:
    from system.settings import HOST,EMAIL,EMAIL_TITLE
except:
    raise Exception('Вкажіть HOST, EMAIL та EMAIL_TITLE в settngs')
...
class AnonymousUser:
    ...
    def save(self):
        raise NotImplementedError("no provider of DB representation for AnonymousUser.")
